...
const MOCK_COMPANIES: Company[] = [
  { id: "1", name: "Payo Coffee Roaster", domain: "payo-coffee.jigsaw-erp.com", initials: "PA", color: "#FF6B6B", notifications: 0 },
  { id: "2", name: "JigsawERP Demosite", domain: "demo.jigsaw-erp.com", initials: "JI", color: "#565DFF", notifications: 3 },
  { id: "3", name: "Bplus HRM Connect", domain: "bplus-hrm.jigsaw-erp.com", initials: "BP", color: "#FF9F43", notifications: 12 },
  { id: "4", name: "Allder Creative Studio", domain: "allder.jigsaw-erp.com", initials: "AL", color: "#10B981", notifications: 5 },
  { id: "5", name: "Savvy Accounting Office", domain: "savvy-acc.jigsaw-erp.com", initials: "SA", color: "#8B5CF6", notifications: 0 },
];
